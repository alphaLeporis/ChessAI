...
class SimpleUtility(Utility):
    ...
    def get_phase(self, board):
        ...
        phase -= (len(board.pieces(chess.KNIGHT, chess.WHITE)) + len(
            board.pieces(chess.KNIGHT, chess.BLACK))) * knight_phase
        phase -= (len(board.pieces(chess.BISHOP, chess.WHITE)) + len(
            board.pieces(chess.BISHOP, chess.BLACK))) * bishop_phase
        phase -= (len(board.pieces(chess.ROOK, chess.WHITE)) + len(board.pieces(chess.ROOK, chess.BLACK))) * rook_phase
        phase -= (len(board.pieces(chess.QUEEN, chess.WHITE)) + len(
            board.pieces(chess.KNIGHT, chess.BLACK))) * queen_phase
    ...
    def king_safety(self, board):
        ...
        next_K = self.next_to_king(board, King)
        next_k = self.next_to_king(board, king)
    ...
    def next_to_king(self, board, king):
